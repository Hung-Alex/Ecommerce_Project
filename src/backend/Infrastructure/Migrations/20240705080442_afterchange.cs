...
{
    /// <inheritdoc />
    public partial class afterchange : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address_Line_2 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    PhoneNumberCode = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Left = table.Column<bool>(type: "bit", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Banners_Users_UpdatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Coupons_Users_UpdatedByUserId",
                        column: x => x.UpdatedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Pulished = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ShipAddress_Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ShipAddress_Email = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ShipAddress_Phone = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ShipAddress_Address = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SlidesImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SlidesImages_Images_ImageId",
                        column: x => x.ImageId,
                        principalTable: "Images",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SlidesImages_Slides_SlideId",
                        column: x => x.SlideId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rattings_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Rattings_Users_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Rattings_Users_UpdatedByUserId",
                        column: x => x.UpdatedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Banners_UpdatedByUserId",
                table: "Banners",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_ProductSkusId",
                table: "CartItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rattings_CreatedByUserId",
                table: "Rattings",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Rattings_ProductId",
                table: "Rattings",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_Rattings_UpdatedByUserId",
                table: "Rattings",
                column: "UpdatedByUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SlidesImages_ImageId",
                table: "SlidesImages",
                column: "ImageId");

            migrationBuilder.CreateIndex(
                name: "IX_SlidesImages_SlideId",
                table: "SlidesImages",
                column: "SlideId");
